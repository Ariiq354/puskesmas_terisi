...
import type { tb_berita_artikel as artikel } from "@prisma/client";
...
export default function Artikel() {
  ...
  useEffect(() => {
    axios.get("/api/artikel?kategori=1").then((res) => {
      setItems(res.data);
    });
  }, []);
      ...
      <div className="container my-12">
        ...
        <div className="container my-10">  
          <form>   
            ...
            className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Search"/>
            </div>
          </form>
        </div>
