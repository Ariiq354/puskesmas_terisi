        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <h2 className="text-4xl font-semibold mb-2">
              Program Upaya <br /> Kesehatan Perseorangan <br /> (UKP)
            </h2>
            <p className="text-xl text-justify py-7">
              UPTD Puskesmas Terisi memiliki Program Upaya Kesehatan
              Perseorangan (UKP) yaitu suatu kegiatan dan atau serangkaian
              ...
              penyakit dan memulihkan kesehatan perseorangan. UKP tersebut
              terdiri dari Pelayanan Pendaftaran dan Rekam Medis, Pelayanan
              Pemeriksaan Umum, Pelayanan MTBS, Pelayanan Kesehatan Gigi dan
              Mulut, Pelayanan KIA/KB, Pelayanan Laboratorium, Pelayanan
              Farmasi, Pelayanan TB.
              <br />
              <br />
          ...
          <div>
            <h2 className="text-4xl font-semibold mb-2">
              Program Upaya <br /> Kesehatan Masyarakat <br /> (UKM)
            </h2>
            <p className="text-xl text-justify py-7">
              UPTD Puskesmas Terisi memiliki Upaya Kesehatan Masyarakat (UKM)
              yang merupakan setiap kegiatan untuk memelihara dan meningkatkan
