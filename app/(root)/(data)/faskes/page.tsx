      ...
      <div className="container flex items-center py-20">
        <div>
          ...
          <p className="text-xl text-justify py-7">
            UPTD Puskesmas Babakan Sari memiliki fasilitas kesehatan jejaring
            yang tersebar di wilayah Kerja Puskesmas Babakan Sari yaitu
            Kelurahan Babakan Sari, Kelurahan Kebon Jayanti, Kelurahan Sukapura
            dan Kelurahan Kebon Kangkung. Fasilitas Kesehatan Jejaring Puskesmas
            Babakan Sari Rumah Sakit Pindad, Klinik Utama, Klinik Pratama serta
            Dokter Praktek dan Bidan Praktek Mandiri.
            <br />
            <br />
            Untuk mengupload laporan bulanan fasilitas kesehatan jejaring
