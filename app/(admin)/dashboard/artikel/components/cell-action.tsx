...
import { ArtikelColumn } from "./column";
import toast from "react-hot-toast";
import axios from "axios";

interface ArtikelColumnProps {
  data: ArtikelColumn;
}

export const CellAction: React.FC<ArtikelColumnProps> = ({ data }) => {
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/artikel`, { data: { id: data.id_berita } });
