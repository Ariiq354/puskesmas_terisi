...
export default function Skrining() {
  return (
    <>
      ...
      <div className="container py-20 w-full bg-teal-800 h-[20rem] sm:h-[15rem] text-white text-[1.3rem] text-justify justify-center md:items-center flex flex-col xl:flex-row">
        <p>
