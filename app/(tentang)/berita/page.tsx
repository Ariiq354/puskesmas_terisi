...
const recentArtikel = dataArtikel.slice(0, 3);
  ...
  <div className="grid gap-6 lg:grid-cols-3 xl:gap-x-12">
    ...
    <div className='grid grid gap-6 lg:grid-cols-3 xl:gap-x-12'>
    ...
    <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
      ...
      <div className="p-6">
        ...
        <p className="mb-4 text-neutral-500 dark:text-neutral-300">
          <small>
            Published <u>{formatDateToDDMMYYYY(item.created_at)}</u> by {item.penulis}
          </small>
        </p>
  ...
  <div className='justify-center text-center py-6'>
        <h2 className="text-2xl font-semibold mt-4 mb-4">Artikel Terbaru</h2>
        </div>
       {/* Add your list of latest news items here */}
       <div className="flex flex-wrap justify-center"> {/* Center the cards */}
